...
import com.tannu.edureach.utils.Class2ContentProvider
import com.tannu.edureach.utils.DownloadHelper

class Class2UnitListActivity : AppCompatActivity() {
    ...
    private fun openPdf(pdfUrl: String, unitName: String) {
        ...
        if (localUri != null) {
            try {
                ...
                android.util.Log.e("Class2Unit", "Error opening downloaded file", e)
    ...
    private class UnitAdapter(
        private val units: List<Class2ContentProvider.UnitContent>,
        private val onUnitClick: (Class2ContentProvider.UnitContent) -> Unit,
        private val onDownloadClick: (Class2ContentProvider.UnitContent) -> Unit
