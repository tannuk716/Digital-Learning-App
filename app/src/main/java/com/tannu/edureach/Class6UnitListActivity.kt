...
import com.tannu.edureach.utils.Class6ContentProvider
import com.tannu.edureach.utils.DownloadHelper

class Class6UnitListActivity : AppCompatActivity() {
    ...
    private fun loadUnits(subjectId: String) {
        val subjectContent = Class6ContentProvider.getSubjectContent(this, subjectId)
    ...
    private fun openPdf(pdfUrl: String, unitName: String) {
        ...
        if (localUri != null) {
            try {
                ...
                android.util.Log.e("Class6Unit", "Error opening downloaded file", e)
    ...
    private class UnitAdapter(
        private val units: List<Class6ContentProvider.UnitContent>,
        private val onUnitClick: (Class6ContentProvider.UnitContent) -> Unit,
        private val onDownloadClick: (Class6ContentProvider.UnitContent) -> Unit
