...
import com.tannu.edureach.utils.Class1ContentProvider
import com.tannu.edureach.utils.DownloadHelper

class Class1UnitListActivity : AppCompatActivity() {
    ...
    private class UnitAdapter(
        private val units: List<Class1ContentProvider.UnitContent>,
        private val onUnitClick: (Class1ContentProvider.UnitContent) -> Unit,
        private val onDownloadClick: (Class1ContentProvider.UnitContent) -> Unit
