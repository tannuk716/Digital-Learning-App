...
import com.tannu.edureach.utils.Class5ContentProvider
import com.tannu.edureach.utils.DownloadHelper

class Class5UnitListActivity : AppCompatActivity() {
    ...
    private fun loadUnits(subjectId: String) {
        val subjectContent = Class5ContentProvider.getSubjectContent(this, subjectId)
    ...
    private fun openPdf(pdfUrl: String, unitName: String) {
        ...
        if (localUri != null) {
            try {
                ...
                android.util.Log.e("Class5Unit", "Error opening downloaded file", e)
    ...
    private class UnitAdapter(
        private val units: List<Class5ContentProvider.UnitContent>,
        private val onUnitClick: (Class5ContentProvider.UnitContent) -> Unit,
        private val onDownloadClick: (Class5ContentProvider.UnitContent) -> Unit
