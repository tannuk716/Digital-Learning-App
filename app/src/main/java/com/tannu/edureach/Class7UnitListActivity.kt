...
import com.tannu.edureach.utils.Class7ContentProvider
import com.tannu.edureach.utils.DownloadHelper

class Class7UnitListActivity : AppCompatActivity() {
    ...
    private fun loadUnits(subjectId: String) {
        val subjectContent = Class7ContentProvider.getSubjectContent(this, subjectId)
    ...
    private fun openPdf(pdfUrl: String, unitName: String) {
        ...
        if (localUri != null) {
            try {
                ...
                android.util.Log.e("Class7Unit", "Error opening downloaded file", e)
        ...
        try {
            ...
            Toast.makeText(this, "Unable to open PDF. Please check your internet connection.", Toast.LENGTH_LONG).show()
        }
    }

    private class UnitAdapter(
        private val units: List<Class7ContentProvider.UnitContent>,
        private val onUnitClick: (Class7ContentProvider.UnitContent) -> Unit,
        private val onDownloadClick: (Class7ContentProvider.UnitContent) -> Unit
