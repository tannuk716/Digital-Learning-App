...
import com.tannu.edureach.utils.Class4ContentProvider
import com.tannu.edureach.utils.DownloadHelper

class Class4UnitListActivity : AppCompatActivity() {
    ...
    private fun loadUnits(subjectId: String) {
        val subjectContent = Class4ContentProvider.getSubjectContent(this, subjectId)
    ...
    private fun openPdf(pdfUrl: String, unitName: String) {
        ...
        if (localUri != null) {
            try {
                ...
                android.util.Log.e("Class4Unit", "Error opening downloaded file", e)
    ...
    private class UnitAdapter(
        private val units: List<Class4ContentProvider.UnitContent>,
        private val onUnitClick: (Class4ContentProvider.UnitContent) -> Unit,
        private val onDownloadClick: (Class4ContentProvider.UnitContent) -> Unit
