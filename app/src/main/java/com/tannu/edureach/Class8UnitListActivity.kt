...
import com.tannu.edureach.utils.Class8ContentProvider
import com.tannu.edureach.utils.DownloadHelper

class Class8UnitListActivity : AppCompatActivity() {
    ...
    private fun openPdf(pdfUrl: String, unitName: String) {
        ...
        if (localUri != null) {
            try {
                ...
                android.util.Log.e("Class8Unit", "Error opening downloaded file", e)
    ...
    private class UnitAdapter(
        private val units: List<Class8ContentProvider.UnitContent>,
        private val onUnitClick: (Class8ContentProvider.UnitContent) -> Unit,
        private val onDownloadClick: (Class8ContentProvider.UnitContent) -> Unit
