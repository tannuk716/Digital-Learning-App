...
class SubjectQuizzesActivity : AppCompatActivity() {
    ...
    private fun loadSubjects() {
        android.util.Log.d("SubjectQuizzes", "Loading quizzes for class: $currentClassId")
        ...
        val adapter = QuizzesSubjectAdapter(allSubjects) { subject ->
    ...
    private class QuizzesSubjectAdapter(
        private val subjects: List<SubjectItem>,
        private val onSubjectClick: (SubjectItem) -> Unit
    ) : RecyclerView.Adapter<QuizzesSubjectAdapter.ViewHolder>() {
