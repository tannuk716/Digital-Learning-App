...
import com.tannu.edureach.utils.Class9ContentProvider
import com.tannu.edureach.utils.DownloadHelper

class Class9UnitListActivity : AppCompatActivity() {
    ...
    private fun loadUnits(subjectId: String) {
        val subjectContent = Class9ContentProvider.getSubjectContent(this, subjectId)
    ...
    private fun openPdf(pdfUrl: String, unitName: String) {
        ...
        if (localUri != null) {
            try {
                ...
                android.util.Log.e("Class9Unit", "Error opening downloaded file", e)
    ...
    private class UnitAdapter(
        private val units: List<Class9ContentProvider.UnitContent>,
        private val onUnitClick: (Class9ContentProvider.UnitContent) -> Unit,
        private val onDownloadClick: (Class9ContentProvider.UnitContent) -> Unit
